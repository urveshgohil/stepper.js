...
1. **Include the Library**: Add the Stepper.js library to your project. You can either download the library files or include them via a CDN.
...
| **indicatorVisible**        | boolean                  | false                  | Include indicators to provide a visual cue for the active tab number, enhancing user experience and navigation clarity.                               |
| **doneProcess**             | boolean                  | false                  | Display indicators of completed processes for preceding tabs, ensuring users are informed about progress.                                             |
