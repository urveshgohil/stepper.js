...
| 3. **containerId**          | Number                     | {{dynamic}}             | Assigns a unique ID to the stepper container.                                                                                                                                  |
...
| 4.1. **currentStep**        | Number                     | 1                       | Utilize the provided value in the parameters to set the current step. This functionality is an option available within the nextButtonEvent configuration.                      |
